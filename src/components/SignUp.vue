    ...
    <div class="signUp_user">
        ...
        <h2 id="email">Correo Electronico</h2>
            <div class= "input-email">
                    <input type="email" v-model="user.email" placeholder="Correo Electrónico de usuario">
            </div>    
        ...
        <h2>Apellidos</h2>
            <div class= "input-apellidos">
                    <input type="text" v-model="user.last_name" placeholder=" Apellidos">
            </div>

        <h2>Departamento</h2>
            <div class= "input-departamento">
                    <input type="text" v-model="user.department" placeholder="Departamento">
            <br>
            </div>
        ...
        <h2>Complemento de dirección</h2>
            <div class= "input-complemento">
                    <input type="text"  v-model="user.address_complement" placeholder="Complemento">
            </div>

        <h2>Código Postal</h2>
            <div class= "input-postal_code">
                    <input type="text"  v-model="user.postal_code" placeholder="Código postal">
            </div>
        <br>
        <br>
